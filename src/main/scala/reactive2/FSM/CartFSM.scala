...
class CartFSM(orderManager: ActorRef, chartId: String = "cart_id")(implicit val domainEventClassTag: ClassTag[CartEvent]) extends PersistentFSM[CartState, CartData, CartEvent] {
